...
var overlayFadeOut,postTransition={in:"",out:""},srStatus=semplice.sr_status,isPreview=semplice.is_preview,activeCoverSlider=!1,sempliceDebug=!1;!0===sempliceDebug&&(console.log("# Scroll Reveal Status on First load: "+srStatus),console.log("# is Preview: "+isPreview)),function(e){"use strict";var t,n,o,a,i,s=e("#content-holder"),r=".overlay-menu-inner",l=".active-content",c=".semplice-cover",p=s.attr("data-active-post"),d=semplice.frontend_mode,u=semplice.transition,m=!1,h={},v=".semplice-navbar",f={viewFactor:.2,opacity:0,distance:"0px",easing:"ease-out",duration:700,scale:1,mobile:!1},g={init:function(){if(g.helper.isMobile()&&FastClick.attach(document.body),g.menu.init(),void 0!==semplice.sr_options){var t=["viewFactor","distance","easing","duration","opacity","scale"];e.each(t,function(e,t){void 0!==semplice.sr_options[t]&&(f[t]="distance"==t?semplice.sr_options[t]+"px":semplice.sr_options[t])})}window.sr=new ScrollReveal,"enabled"==srStatus&&"static"==d&&g.helper.reveal(!0),g.helper.photoSwipeIndexes("init"),g.helper.initVideos()},main:{init:function(e,t){if(t)g.menu.showNavbar(!1,!1,!0),g.show.postFirstLoad(),"enabled"==srStatus&&g.helper.reveal(!0);else{var n=g.helper.getPostInfo(e);g.get.post(n,!1,!1)}}},get:{post:function(n,o,a){p=s.attr("data-active-post"),t=g.helper.generateId("post"),!0===sempliceDebug&&console.log("# Active Element ID: "+p+"\n# New Element ID: "+t),e.ajax({type:"GET",url:semplice.semplice_api_url+"/post",data:{id:n.id,term:n.term,taxonomy:n.taxonomy,page:n.page},beforeSend:function(e){e.setRequestHeader("X-WP-Nonce",semplice.nonce)},success:function(t){!0===sempliceDebug&&console.log(t);var n=e.extend(!0,{},t);g.show.post(n,o,a)},error:function(e){console.log(e)}})}},show:{postFirstLoad:function(){NProgress.done()},post:function(n,o,a){g.helper.setSrStatus(n.content),s.append('<div id="content-'+t+'" class="content-container is-top"></div>'),o||"disabled"==u.status?(g.helper.updateSiteMeta(n),g.helper.changeActiveDivStatus(t,a),g.helper.appendContent(t,n.content,n.post_settings,n.has_password,n.id),g.helper.killCoverSlider(!0),g.helper.restoreScrollPosition(a),"enabled"==srStatus&&g.helper.reveal(!1),NProgress.done(),g.helper.afterPageTransitions()):(g.helper.updateSiteMeta(n),m=!0,g.transitions[u.out.effect]("out",e("#content-"+p),u.out,!0,!0),g.helper.changeActiveDivStatus(t,a),g.helper.appendContent(t,n.content,n.post_settings,n.has_password,n.id),g.transitions[u.in.effect]("in",e("#content-"+t),u.in,!1,!1))}},transitions:{fadeIn:function(e,t,n,o,a){postTransition[e]=TweenLite.to(t,n.duration,{opacity:1,ease:n.ease,clearProps:"opacity",onComplete:function(){g.transitions.onComplete(t,o,a)}})},fadeOut:function(e,t,n,o,a){postTransition[e]=TweenLite.to(t,n.duration,{opacity:0,ease:n.ease,clearProps:"opacity",onComplete:function(){g.transitions.onComplete(t,o,a)}})},moveLeftToRight:function(e,t,n,o,a){postTransition[e]=TweenLite.to(t,n.duration,{xPercent:n.to,ease:n.ease,clearProps:"xPercent",onComplete:function(){g.transitions.onComplete(t,o,a)}})},moveRightToLeft:function(e,t,n,o,a){postTransition[e]=TweenLite.to(t,n.duration,{xPercent:n.to,ease:n.ease,clearProps:"xPercent",onComplete:function(){g.transitions.onComplete(t,o,a)}})},moveTopToBottom:function(e,t,n,o,a){postTransition[e]=TweenLite.to(t,n.duration,{yPercent:100,ease:n.ease,clearProps:"yPercent",onComplete:function(){g.transitions.onComplete(t,o,a)}})},moveBottomToTop:function(e,t,n,o,a){postTransition[e]=TweenLite.to(t,n.duration,{yPercent:-100,ease:n.ease,clearProps:"yPercent",onComplete:function(){g.transitions.onComplete(t,o,a)}})},onComplete:function(n,o,a){n.removeClass("position-right position-left position-bottom position-normal position-top hide-on-init is-top");var i="in";u.out.duration>u.in.duration&&(i="out"),o?(e(n).hide(),"out"==i&&g.helper.afterPageTransitions()):(postTransition.out.totalProgress(1),g.helper.killCoverSlider(!0),e("#content-"+p).remove(),NProgress.done(),"in"==i&&g.helper.afterPageTransitions(),e("#content-"+t).removeClass("transition-hidden"))}},menu:{init:function(){"align-top"==e(r+" nav").data("align")&&e(r+" nav").css("top",e("header").height()+"px"),"align-top"!=e(r+" nav").data("align")&&g.menu.responsiveOverlay()},open:function(t){e(".hamburger").attr({disabled:"disabled","data-status":"open"}),t.removeClass("open-menu").addClass("close-menu"),i=g.helper.getRgba(e(v).css("background-color")),g.menu.navbarBgOverlayVisibility(e(v).data("bg-overlay-visibility")),e("#overlay-menu").stop().css("z-index","119"),TweenLite.to("#overlay-menu",.35,{opacity:1,onComplete:function(){g.menu.afterOpenMenu()}}),setTimeout(function(){g.menu.showMenuItems(e(r+" nav ul li"))},50)},close:function(t){if("disabled"!==e(".hamburger").attr("disabled")){var n="open-menu";e("nav.standard").length>0&&(n+=" responsive-menu"),e(".hamburger").attr({disabled:"disabled","data-status":"closed"}),t.removeClass("close-menu").addClass(n),g.menu.navbarBgOverlayVisibility("visible"),e(v).insertBefore("#overlay-menu"),e(v).hasClass("non-sticky-nav")||!0===g.helper.isMobile()||e(v).css("position","fixed"),e("body").removeClass("open-menu"),s.css("width","100%"),TweenLite.to("#overlay-menu",.35,{opacity:0,onComplete:function(){g.menu.afterCloseMenu()}})}},showMenuItems:function(t){var n=0;return t.each(function(){var t=e(this);t.addClass("before-fade"),TweenLite.to(e(this),.35,{opacity:1,y:0,clearProps:"y",delay:n,onComplete:function(){t.removeClass("before-fade")}}),n+=.08})},responsiveOverlay:function(){a=e("header").height(),t=e(r+" nav").height();var t=2*a+(t+40);t>=e(window).height()?e(r+" nav").addClass("align-top").css("top",a+40):e(r+" nav").removeClass("align-top").css("top","")},afterOpenMenu:function(){e(v).insertBefore(".overlay-menu-inner").css("position","absolute");var t=e(window).width();e("body").addClass("open-menu");var n=100*t/e(window).width();s.css("width",n+"%"),e(".hamburger").removeAttr("disabled")},afterCloseMenu:function(){e("#overlay-menu").css("z-index","-1"),e(r+" nav ul li").removeAttr("style"),e(".hamburger").removeAttr("disabled")},navbarBgOverlayVisibility:function(t){var n=0;"visible"==t&&(n=i.alpha),e(v).css("background-color","rgba("+i.red+", "+i.green+", "+i.blue+", "+n+")")},loadNav:function(e,t){if("false"!=t){var n;void 0!==semplice.menus[e]?(n=semplice.menus[e],!0===sempliceDebug&&console.log("# Navigation: "+e)):void 0!==semplice.menus.default?(n=semplice.menus[semplice.menus.default],!0===sempliceDebug&&console.log("# Navigation (default): "+semplice.menus.default)):(n=semplice.menus.system_default,!0===sempliceDebug&&console.log("# Navigation (system default)")),g.menu.showNavbar(!0,n,!1)}},showNavbar:function(n,o,a){var i="";void 0!==o.css&&(i=o.css.replace(/#content-holder/g,"#content-"+t).replace(/body/g,"#content-"+t)),n?(e("#"+t+"-post-css").append(i),e(l).prepend(o.html),g.helper.setActiveMenuItem(e(l),a),e(v).css("opacity",1)):(e(l).prepend(e("#overlay-menu")),e(l).prepend(e(v)),g.helper.setActiveMenuItem(e(l),a),e(v).css("transform","translate(0px, -"+e(v).height()+"px)"),TweenLite.to(v,.6,{opacity:1,y:0,ease:Expo.easeOutIn,clearProps:"y"}))},hideMenuOnPageChange:function(){s.css("width","100%"),e("body").removeClass("open-menu")}},helper:{getUrl:function(e,t){var n={new:{full:g.helper.removeSlash(e),noHash:"",hash:""},active:{full:g.helper.removeSlash(t),noHash:""}},o=g.helper.parseUrl(n.new.full),a=g.helper.parseUrl(n.active.full);return n.new.noHash=n.new.full.replace(o.hash,""),n.active.noHash=n.active.full.replace(a.hash,""),n.new.noHash=g.helper.removeSlash(n.new.noHash),n.active.noHash=g.helper.removeSlash(n.active.noHash),o.hash&&(n.new.hash=o.hash),n},getPostSlug:function(e){return(e=g.helper.removeSlash(e,"last")).substr(e.lastIndexOf("/")+1)},getPostInfo:function(e){var t={id:"",term:"",taxonomy:"",slug:"",page:0,hash:""};e=g.helper.removeSlash(e);var n=g.helper.parseUrl(e),a=n.pathname.match(/\/page\/([0-9]+)/);return null!==a&&(t.page=a[1],n.pathname=n.pathname.replace(a[0],"")),n.hash&&(t.hash=n.hash),t.slug=g.helper.getPostSlug(n.pathname),t.id=semplice.post_ids[t.slug],e==semplice.base_url?t.id=semplice.frontpage_id:e==semplice.blog_home?t.id="posts":n.pathname.indexOf(semplice.category_base)>-1?(t.term=t.slug,t.id="category",t.taxonomy="category"):n.pathname.indexOf(semplice.tag_base)>-1?(t.term=t.slug,t.id="post_tag",t.taxonomy="post_tag"):void 0==t.id&&(t.id="notfound"),!0===sempliceDebug&&console.log("# Pathname: "+n.pathname+"\n# Pagination: "+t.page+"\n# Slug: "+t.slug+"\n# Post-ID: "+t.id+"\n# Taxonomy: "+t.taxonomy+"\n# Term: "+t.term+"\n# Hash: "+t.hash+"\n# Menu Item ID: "+o),t},parseUrl:function(e){var t=document.createElement("a");return t.href=e,t},removeSlash:function(e){return"/"==e.slice(-1)&&(e=e.replace(/\/+$/,"")),e},getHash:function(){var e=window.location.hash;return!!e&&e.replace("/","")},noHash:function(e){var t=document.createElement("a");return t.href=e,t.hash?e.replace(t.hash,""):e},goToHash:function(t){var n=.8;e("body").hasClass("open-menu")&&(n=0),e(t).length>0?TweenLite.to(window,n,{scrollTo:{y:e(t).offset().top-e(v).height()},ease:Expo.easeInOut,onComplete:function(){window.location.hash=t}}):window.location.hash=t},isValidUrl:function(e){var t=!0;return g.helper.isExternal(e.new.full)&&(t=!1),"wp-admin"==g.helper.getPostSlug(e.new.full)&&(t=!1),"#"==e.new.full.charAt(0)&&(t=!1),e.new.full.indexOf("replyto")>-1&&(t=!1),t},checkDomain:function(e){return 0===e.indexOf("//")&&(e=location.protocol+e),e.toLowerCase().replace(/([a-z])?:\/\//,"$1").split("/")[0]},isExternal:function(e){return(e.indexOf(":")>-1||e.indexOf("//")>-1)&&g.helper.checkDomain(location.href)!==g.helper.checkDomain(e)},changePage:function(t,o,a){var i=e(window).scrollTop(),s=g.helper.generateId("page");history.replaceState({id:s},"",o),h[s]=i,!0===sempliceDebug&&console.log("#############################################################\n# Action: Click on Link\n# History Page ID: "+s+" \n# Active URL: "+o+" \n# Scroll Position: "+i+"\n# New URL: "+t),e(window).scrollTop(0),"leftToRight"==u.preset||"rightToLeft"==u.preset||"fade"==u.preset?("enabled"==u.status&&e(l).css("top","-"+i+"px"),"fixed"==e(v).css("position")&&e(v).css({position:"absolute",top:i})):"topToBottom"!=u.preset&&"bottomToTop"!=u.preset||(e(l).wrapInner('<div class="transition-wrap"></div>'),e(".content-container").css({height:"100%",overflowY:"hidden"}),e(".transition-wrap").css("top","-"+i+"px")),history.pushState(null,a,t),g.main.init(t,!1),n=t},getDataAttributes:function(t){return{handler:e(t).attr("data-handler"),postId:e(t).attr("data-post-id"),postType:e(t).attr("data-post-type")}},getPostType:function(e){return semplice.posts[e][type]},updateSiteMeta:function(t){var n=t.title;-1==t.title.indexOf(semplice.site_name)&&(n=t.title+" - "+semplice.site_name);var o={"head > title":n,'link[rel="canonical"]':window.location.href},a={_yoast_wpseo_title:"head > title",_yoast_wpseo_metadesc:'meta[name="description"]',"_yoast_wpseo_opengraph-image":'meta[property="og:image"]',"_yoast_wpseo_opengraph-title":'meta[property="og:title"]',"_yoast_wpseo_opengraph-description":'meta[property="og:description"]',"_yoast_wpseo_twitter-image":'meta[name="twitter:image"]',"_yoast_wpseo_twitter-title":'meta[name="twitter:title"]',"_yoast_wpseo_twitter-description":'meta[name="twitter:description"]',_yoast_wpseo_canonical:'link[rel="canonical"]'};if(void 0!==t.post_settings){var i=t.post_settings;void 0!==i.seo&&e.each(i.seo,function(e,t){o[a[e]]=t})}e.each(o,function(t,n){"head > title"==t?e(t).text(n):'link[rel="canonical"]'==t?e(t).attr("href",n):e(t).attr("content",n)})},getActiveContentDiv:function(){return e(l).attr("data-content-div")},changeActiveDivStatus:function(t,n){e(".content-container").removeClass("active-content position-right position-left position-bottom position-top"),s.attr("data-active-post",t),n||"disabled"==u.status?e("#content-"+t).addClass("active-content"):e("#content-"+t).addClass("active-content position-"+u.in.position+" "+u.in.visibility),"topToBottom"!=u.preset&&"bottomToTop"!=u.preset||e(l).css({height:"100%",overflowY:"hidden"})},appendContent:function(t,n,o,a,i){void 0!==n&&(a?(e("#content-"+t).html(semplice.password_form),e(".post-password-submit").attr("data-id",i)):e("#content-"+t).html(n.html),e("head").append('<style type="text/css" id="'+t+'-post-css">'+n.css.replace(/#content-holder/g,"#content-"+t).replace(/body/g,"#content-"+t)+"</style>"),n.js,e.isEmptyObject(n.js)||e("body").append('<script type="text/javascript" id="'+t+'-motion-js">'+n.js+"<\/script>")),void 0!==o&&o?void 0!==o.meta.navbar?g.menu.loadNav(o.meta.navbar,o.meta.navbar_visibility):g.menu.loadNav(!1,o.meta.navbar_visibility):g.menu.loadNav(!1,!0),g.helper.initVideos(),g.helper.photoSwipeIndexes(t)},afterPageTransitions:function(){m=!1,e(".content-container").css({top:"",height:"",overflowY:""}),e("#content-"+p).remove(),e("#"+p+"-post-css").remove(),e("#"+p+"-motion-js").remove(),e(window).scroll(),!0===sempliceDebug&&(console.log("# Transition Status: Done!"),console.log("#############################################################")),"enabled"==srStatus&&g.helper.reveal(!1);var t=g.helper.getHash();t&&g.helper.goToHash(t)},generateId:function(e){return e+"_"+Math.random().toString(36).substr(2,9)},restoreScrollPosition:function(t){t&&(null!=history.state?setTimeout(function(){!0===sempliceDebug&&console.log("#############################################################\n# Action: Browser Button\n# Page ID: "+history.state.id+" \n# URL: "+window.location.href+" \n# Restore Scroll Position: "+h[history.state.id]+"\n#############################################################"),e(document).scrollTop(h[history.state.id])},0):setTimeout(function(){!0===sempliceDebug&&console.log("#############################################################\n# Action: Browser Button\n# Page ID: Most Recent \n# URL: "+window.location.href+" \n# Restore Scroll Position: "+h.most_recent+"\n#############################################################"),e(document).scrollTop(h.most_recent)},0))},reveal:function(t){var n=e("section").length,o=0;e("section").each(function(){e(this).isOnScreen(.01,.01)&&1!=t||e(this).addClass("reveal"),n==(o+=1)&&(sr.reveal(".reveal",f),t&&e(l).removeClass("hide-on-init"))})},isMobile:function(){var e=!1;return function(t){(/(android|bb\d+|meego).+mobile|android|ipad|playbook|silk|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|mobile.+firefox|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows (ce|phone)|xda|xiino/i.test(t)||/1207|6310|6590|3gso|4thp|50[1-6]i|770s|802s|a wa|abac|ac(er|oo|s\-)|ai(ko|rn)|al(av|ca|co)|amoi|an(ex|ny|yw)|aptu|ar(ch|go)|as(te|us)|attw|au(di|\-m|r |s )|avan|be(ck|ll|nq)|bi(lb|rd)|bl(ac|az)|br(e|v)w|bumb|bw\-(n|u)|c55\/|capi|ccwa|cdm\-|cell|chtm|cldc|cmd\-|co(mp|nd)|craw|da(it|ll|ng)|dbte|dc\-s|devi|dica|dmob|do(c|p)o|ds(12|\-d)|el(49|ai)|em(l2|ul)|er(ic|k0)|esl8|ez([4-7]0|os|wa|ze)|fetc|fly(\-|_)|g1 u|g560|gene|gf\-5|g\-mo|go(\.w|od)|gr(ad|un)|haie|hcit|hd\-(m|p|t)|hei\-|hi(pt|ta)|hp( i|ip)|hs\-c|ht(c(\-| |_|a|g|p|s|t)|tp)|hu(aw|tc)|i\-(20|go|ma)|i230|iac( |\-|\/)|ibro|idea|ig01|ikom|im1k|inno|ipaq|iris|ja(t|v)a|jbro|jemu|jigs|kddi|keji|kgt( |\/)|klon|kpt |kwc\-|kyo(c|k)|le(no|xi)|lg( g|\/(k|l|u)|50|54|\-[a-w])|libw|lynx|m1\-w|m3ga|m50\/|ma(te|ui|xo)|mc(01|21|ca)|m\-cr|me(rc|ri)|mi(o8|oa|ts)|mmef|mo(01|02|bi|de|do|t(\-| |o|v)|zz)|mt(50|p1|v )|mwbp|mywa|n10[0-2]|n20[2-3]|n30(0|2)|n50(0|2|5)|n7(0(0|1)|10)|ne((c|m)\-|on|tf|wf|wg|wt)|nok(6|i)|nzph|o2im|op(ti|wv)|oran|owg1|p800|pan(a|d|t)|pdxg|pg(13|\-([1-8]|c))|phil|pire|pl(ay|uc)|pn\-2|po(ck|rt|se)|prox|psio|pt\-g|qa\-a|qc(07|12|21|32|60|\-[2-7]|i\-)|qtek|r380|r600|raks|rim9|ro(ve|zo)|s55\/|sa(ge|ma|mm|ms|ny|va)|sc(01|h\-|oo|p\-)|sdk\/|se(c(\-|0|1)|47|mc|nd|ri)|sgh\-|shar|sie(\-|m)|sk\-0|sl(45|id)|sm(al|ar|b3|it|t5)|so(ft|ny)|sp(01|h\-|v\-|v )|sy(01|mb)|t2(18|50)|t6(00|10|18)|ta(gt|lk)|tcl\-|tdg\-|tel(i|m)|tim\-|t\-mo|to(pl|sh)|ts(70|m\-|m3|m5)|tx\-9|up(\.b|g1|si)|utst|v400|v750|veri|vi(rg|te)|vk(40|5[0-3]|\-v)|vm40|voda|vulc|vx(52|53|60|61|70|80|81|83|85|98)|w3c(\-| )|webc|whit|wi(g |nc|nw)|wmlb|wonu|x700|yas\-|your|zeto|zte\-/i.test(t.substr(0,4)))&&(e=!0)}(navigator.userAgent||navigator.vendor||window.opera),e},getRgba:function(e){var t={red:null,green:null,blue:null,alpha:null};if("string"==typeof e)if(0===e.indexOf("#"))t=3==(e=e.substr(1)).length?{red:parseInt(e[0]+e[0],16),green:parseInt(e[1]+e[1],16),blue:parseInt(e[2]+e[2],16),alpha:1}:{red:parseInt(e.substr(0,2),16),green:parseInt(e.substr(2,2),16),blue:parseInt(e.substr(4,2),16),alpha:1};else if(0===e.indexOf("rgb(")){n=e.indexOf(",");t={red:parseInt(e.substr(4,n)),green:parseInt(e.substr(n+1,e.indexOf(",",n))),blue:parseInt(e.substr(e.indexOf(",",n+1)+1,e.indexOf(")"))),alpha:1}}else if(0===e.indexOf("rgba(")){var n=e.indexOf(","),o=e.indexOf(",",n+1);t={red:parseInt(e.substr(5,n)),green:parseInt(e.substr(n+1,o)),blue:parseInt(e.substr(e.indexOf(",",n+1)+1,e.indexOf(",",o))),alpha:parseFloat(e.substr(e.indexOf(",",o+1)+1,e.indexOf(")")))}}else{var a={acqua:"#0ff",teal:"#008080",blue:"#00f",navy:"#000080",yellow:"#ff0",olive:"#808000",lime:"#0f0",green:"#008000",fuchsia:"#f0f",purple:"#800080",red:"#f00",maroon:"#800000",white:"#fff",gray:"#808080",silver:"#c0c0c0",black:"#000"};void 0!=a[e]&&(t=getColorValues(a[e]))}return t},setSrStatus:function(e){void 0!==e.branding&&void 0!==e.branding.scroll_reveal&&(srStatus=e.branding.scroll_reveal,!0===sempliceDebug&&console.log("Changing Scroll Reveal Status to "+srStatus))},photoSwipe:function(t){var n=document.querySelectorAll(".pswp")[0],o=[];e(".lightbox-item").each(function(){o.push({src:e(this).attr("src"),w:e(this).attr("width"),h:e(this).attr("height"),msrc:e(this).attr("src")})});var a={index:parseInt(t),history:!1,shareEl:!1,getThumbBoundsFn:function(e){var t=document.querySelectorAll(".lightbox-item")[e],n=window.pageYOffset||document.documentElement.scrollTop,o=t.getBoundingClientRect();return{x:o.left,y:o.top+n,w:o.width}}};new PhotoSwipe(n,PhotoSwipeUI_Default,o,a).init()},photoSwipeIndexes:function(t){t="init"==t?"#content-holder":"#content-"+t,e("#content-holder .post").find(".gallery").length>0&&e(".gallery-item").each(function(){e(this).find("a").addClass("semplice-lightbox"),e(this).find("img").addClass("lightbox-item")});var n=0;e(t).find(".lightbox-item").each(function(){e(this).attr("data-photoswipe-index",n),n++})},scrollToTop:function(e){TweenLite.to(window,1,{scrollTo:{y:0},ease:Expo.easeInOut})},scrollToContent:function(t){var n;n="absolute"==e(v).css("position")?0:e(v).height()-1,e(v).hasClass("scroll-to-top")&&(n=0),TweenLite.to(window,1,{scrollTo:{y:e(c).height()-n},ease:Expo.easeInOut})},initVideos:function(){e("#content-holder .post").length>0&&(e("iframe").wrap('<div class="responsive-video"></div>'),e(".wp-video").each(function(){e(this).attr("style","").wrap('<div class="responsive-video"></div>')})),e(".ce-video video, .wp-video video, .wp-audio-shortcode").mediaelementplayer({pauseOtherPlayers:!1,success:function(t,n){var o=e(t.id?"#"+t.id:t);o.attr("poster",""),t.addEventListener("ended",function(e){o.parents(".mejs-inner").find(".mejs-poster").show()})}})},postPassword:function(t){var n=e(t).attr("data-id"),o=e('[name="post_password"]').val();e.ajax({type:"GET",url:semplice.semplice_api_url+"/post-password",data:{id:n,password:o},beforeSend:function(e){e.setRequestHeader("X-WP-Nonce",semplice.nonce)},success:function(t){"wrong-password"!=t&&e(".sections").replaceWith(t)},error:function(e){console.log(e)}})},getActiveMenuItem:function(e){var t=e.closest("li").attr("class"),n=null;return void 0!==t&&(null!==t.match(/menu-item-\d+/)?n=t.match(/menu-item-\d+/):null!==t.match(/page-item-\d+/)&&(n=t.match(/page-item-\d+/))),null!==n&&(n=n[0]),n},setActiveMenuItem:function(e,t){t||(e.find(".menu-item, .page_item").removeClass("current-menu-item current_page_item"),e.find("."+o).addClass("current-menu-item"))},removeCommentReplyLink:function(){e("#reply-title a").remove()},changeSlide:function(t){var n=t.attr("data-type"),o=t.attr("data-direction");"vertical"==n?"next"==o?e.fn.fullpage.moveSectionDown():e.fn.fullpage.moveSectionUp():"next"==o?e.fn.fullpage.moveSlideRight():e.fn.fullpage.moveSlideLeft()},killCoverSlider:function(n){var o=!0;!0===activeCoverSlider&&(!0===n&&e("#content-"+t).find("#coverslider").length>0&&(o=!1),!0===o&&(e.fn.fullpage.destroy("all"),e("#fp-parallax-stylesheet").remove(),e("#fp-parallax-transitions").remove(),e("#fp-parallax-transition-class").remove(),activeCoverSlider=!1))}}};g.init(),"static"!=d?(NProgress.configure({showSpinner:!1}),NProgress.start(),g.main.init(window.location.href,!0),e(document).on("click","a",function(t){if(e(this).hasClass("semplice-event"))g[e(this).attr("data-event-type")][e(this).attr("data-event")](e(this));else if("_blank"!=e(this).attr("target")&&void 0!==e(this).attr("href")&&!1!==e(this).attr("href")){var a=e(this).attr("href");if("#"==a.charAt(0)){var i=g.helper.parseUrl(window.location.href);n=i.href.replace(i.hash,""),a=n+a}a=g.helper.getUrl(a,window.location.href);var s=e(this).text();if(e(this).hasClass("semplice-lightbox"))t.preventDefault();else if(g.helper.isValidUrl(a)){if(t.metaKey||t.shiftKey||t.ctrlKey)return;t.preventDefault(),0==m&&(a.new.noHash!=a.active.noHash?(NProgress.start(),o=g.helper.getActiveMenuItem(e(this)),e("body").hasClass("open-menu")?overlayFadeOut=TweenLite.to("#overlay-menu",.35,{opacity:0,onComplete:function(){g.menu.hideMenuOnPageChange(),g.helper.changePage(a.new.full,a.active.full,s)}}):g.helper.changePage(a.new.full,a.active.full,s)):a.new.hash&&a.new.hash!=window.location.hash?g.helper.goToHash(a.new.hash):e("body").hasClass("open-menu")&&g.menu.close(e(".close-menu")))}else if(a.new.full.indexOf("replyto")>-1){var r=a.new.full.match(/replytocom=\d+/);if(null!==r&&(r=parseInt(r[0].replace("replytocom=","")),e.isNumeric(r))){g.helper.goToHash("#reply-title"),e("#comment_parent").val(r);var l=e("#comment-"+r).find("cite").first().text();e("#reply-title").html(""),e("#reply-title").append('Leave a reply to <a href="#comment-'+r+'">'+l+'</a><a rel="nofollow" class="semplice-event" data-event-type="helper" data-event="removeCommentReplyLink" id="cancel-comment-reply-link">Cancel Reply</a>')}t.preventDefault()}}}),window.onpopstate=function(e){if(TweenLite.killTweensOf(".content-container"),g.helper.noHash(n)!=g.helper.noHash(window.location.href)){void 0!==overlayFadeOut&&overlayFadeOut.isActive()&&(overlayFadeOut.kill(),g.menu.hideMenuOnPageChange()),t!=p&&(g.helper.killCoverSlider(!1),s.html(""));var o=g.helper.getPostInfo(window.location.href);g.get.post(o,!0,!0),n=window.location.href}}):e(document).on("click","a",function(t){e(this).hasClass("semplice-event")&&g[e(this).attr("data-event-type")][e(this).attr("data-event")](e(this))}),e("#content-holder").on("click",".semplice-lightbox",function(){g.helper.photoSwipe(e(this).children("img").attr("data-photoswipe-index"))}),e("#content-holder").on("click",".semplice-menu",function(){"open"==e(".hamburger").attr("data-status")?g.menu.close(e(".close-menu")):g.menu.open(e(".open-menu"))}),e(window).on("scroll",function(t){if("static"!=d&&(null==history.state&&e(document).scrollTop()>0?h.most_recent=e(window).scrollTop():e(document).scrollTop()>0&&(h[history.state.id]=e(window).scrollTop())),"parallax"==e(c).attr("data-parallax")&&"zoom"!=e(".cover-image").attr("data-cover-zoom")){var n=e(window).scrollTop()/3;e(".cover-image").css({transform:"translate3d(0px, "+n+"px, 0px)"})}"enabled"==e(v).attr("data-cover-transparent")&&(e(this).scrollTop()>=e(c).height()-(e(".semplice-navbar").height()+20)?e(".semplice-navbar").removeClass("cover-transparent"):e(".semplice-navbar").addClass("cover-transparent")),e(this).scrollTop()>400?e(".back-to-top").fadeIn(700):e(".back-to-top").fadeOut(700)}),e(window).on("resize",function(t){"align-top"!=e(r+" nav").data("align")&&g.menu.responsiveOverlay()}),e(window).on("hashchange",function(t){e("body").hasClass("open-menu")&&g.menu.close(e(".close-menu"))})}(jQuery);