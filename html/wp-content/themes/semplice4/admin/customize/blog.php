			...
			if(is_array($options)) {
				...
				if(isset($options['blog_bg_color'])) {
					if($is_admin) {
						...
						$css .= '.is-frontend .posts { background-color: ' . $options['blog_bg_color'] . '; }';
					}
				}
				// divider color
				...
				if(isset($options['blog_head_meta_font_size'])) {
					$css .= '.post .post-heading p a { font-size: ' . $options['blog_head_meta_font_size'] . '; }';
				}
				// blog meta alignment
				...
				if(isset($options['blog_head_meta_color'])) {
					$css .= '.post .post-heading p a { color: ' . $options['blog_head_meta_color'] . '; }';
				}
				...
				if(isset($options['blog_link_color'])) {
					$css .= '.post .post-content a { color: ' . $options['blog_link_color'] . '; }';
				}
